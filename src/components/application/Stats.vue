...
const isMobile = () => screenWidth.value <= 768; // Adjust the width as per your mobile breakpoint

function shouldRenderContent(x){
  return isMobile() && currentStat.value === x;
}
...
<template>
  <div class="flex flex-row items-center justify-around gap-1">
    <div @click="decrementStat" class="xl:hidden">
    ...
    <div
      ...
      class="flex h-fit w-2/3 items-center justify-around rounded-md p-4 border border-gray-300 border-opacity-30 shadow-[0_8px_30px_rgb(0,0,0,0.1)] "
    >
      <svg
    ...
    >
      ...
      <div class="w-3/5 flex shrink-0 flex-col">
    ...
    >
      <div class="flex flex-row gap-4">
        <div
            class="flex flex-1  items-center justify-around rounded-md p-4 border border-gray-300 border-opacity-30 shadow-[0_8px_30px_rgb(0,0,0,0.1)] "
        >
          <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
    ...
    <div @click="incrementStat" class="xl:hidden">
